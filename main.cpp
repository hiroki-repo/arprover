...
void usage() {
    fprintf(stdout, "arprover (based arpreply version 1.0), release date: 2025-11-31\n\n"
                    "Usage: iphijacker --help | -list | [-i interfacename] [-itval n] -rti ipaddr -rqi ipaddr [-rqm macaddr] [-q]\n"
...
//        getARPReplyMAC(ipSock.fdSock, iInterfaceName, rti);
    ...
    unsigned char macaddrs[256][6]{'\0'};
    unsigned char ipaddrs[256][4]{'\0'};
    unsigned char macptx{'\0'};
    time_t macbindtimed[256];
    ...
    for (;;){
        time_t timenowxxx = time(NULL);
        for (int cnt = 0;cnt<256;cnt++){
            if ((macbindtimed[cnt] + 60) <= timenowxxx){
                memset(macaddrs[cnt],0,6);
                memset(ipaddrs[cnt],0,4);
                macbindtimed[cnt] = 0;
            }
        }
        MACHeader &pMAC = (MACHeader&)buf;
        ...
        if (!(sockAddrghx.sll_protocol == htons(ETH_P_ARP))){continue;}
        //if (((pMAC2.arpHeader.TargetMAC[0] == 0) && (pMAC2.arpHeader.TargetMAC[1] == 0) && (pMAC2.arpHeader.TargetMAC[2] == 0) && (pMAC2.arpHeader.TargetMAC[3] == 0) && (pMAC2.arpHeader.TargetMAC[4] == 0) && (pMAC2.arpHeader.TargetMAC[5] == 0))){continue;}
        bool additionally = true;
        if ((((pMAC2.arpHeader.TargetIP[0]) == (pMAC.arpHeader.TargetIP[0])) && ((pMAC2.arpHeader.TargetIP[1]) == (pMAC.arpHeader.TargetIP[1])) && ((pMAC2.arpHeader.TargetIP[2]) == (pMAC.arpHeader.TargetIP[2])) && ((pMAC2.arpHeader.TargetIP[3]) == (pMAC.arpHeader.TargetIP[3]))) && (((pMAC2.destMACAddr[0] == pMAC.destMACAddr[0]) && (pMAC2.destMACAddr[1] == pMAC.destMACAddr[1]) && (pMAC2.destMACAddr[2] == pMAC.destMACAddr[2]) && (pMAC2.destMACAddr[3] == pMAC.destMACAddr[3]) && (pMAC2.destMACAddr[4] == pMAC.destMACAddr[4]) && (pMAC2.destMACAddr[5] == pMAC.destMACAddr[5])) || ((pMAC2.destMACAddr[0] & 0x01)))){
            for (int cnt=0;cnt<256;cnt++){
                if (((ipaddrs[cnt][0] == pMAC2.arpHeader.SenderIP[0]) && (ipaddrs[cnt][1] == pMAC2.arpHeader.SenderIP[1]) && (ipaddrs[cnt][2] == pMAC2.arpHeader.SenderIP[2]) && (ipaddrs[cnt][3] == pMAC2.arpHeader.SenderIP[3]))){ additionally = false; break; }
            };
            for (int cnt=0;cnt<256;cnt++){
                if (((ipaddrs[cnt][0] == 0) && (ipaddrs[cnt][1] == 0) && (ipaddrs[cnt][2] == 0) && (ipaddrs[cnt][3] == 0))){ macptx = cnt; break; }
            };
            if (additionally == true){
                memcpy(macaddrs[macptx],pMAC2.arpHeader.SenderMAC,6);
                memcpy(ipaddrs[macptx],pMAC2.arpHeader.SenderIP,4);
                macbindtimed[macptx] = time(NULL);
            }
        } else if (!((pMAC2.arpHeader.TargetMAC[0] == 0) && (pMAC2.arpHeader.TargetMAC[1] == 0) && (pMAC2.arpHeader.TargetMAC[2] == 0) && (pMAC2.arpHeader.TargetMAC[3] == 0) && (pMAC2.arpHeader.TargetMAC[4] == 0) && (pMAC2.arpHeader.TargetMAC[5] == 0))){
            macptx = 0;
            for (int cnt=0;cnt<256;cnt++){
                if (((pMAC2.arpHeader.SenderMAC[0] == macaddrs[cnt][0]) && (pMAC2.arpHeader.SenderMAC[1] == macaddrs[cnt][1]) && (pMAC2.arpHeader.SenderMAC[2] == macaddrs[cnt][2]) && (pMAC2.arpHeader.SenderMAC[3] == macaddrs[cnt][3]) && (pMAC2.arpHeader.SenderMAC[4] == macaddrs[cnt][4]) && (pMAC2.arpHeader.SenderMAC[5] == macaddrs[cnt][5]))){ macptx = cnt; break; }
            };
            if (!(((pMAC2.arpHeader.TargetIP[0]) == (pMAC.arpHeader.TargetIP[0])) && ((pMAC2.arpHeader.TargetIP[1]) == (pMAC.arpHeader.TargetIP[1])) && ((pMAC2.arpHeader.TargetIP[2]) == (pMAC.arpHeader.TargetIP[2])) && ((pMAC2.arpHeader.TargetIP[3]) == (pMAC.arpHeader.TargetIP[3]))) && ((pMAC2.arpHeader.SenderMAC[0] == macaddrs[macptx][0]) && (pMAC2.arpHeader.SenderMAC[1] == macaddrs[macptx][1]) && (pMAC2.arpHeader.SenderMAC[2] == macaddrs[macptx][2]) && (pMAC2.arpHeader.SenderMAC[3] == macaddrs[macptx][3]) && (pMAC2.arpHeader.SenderMAC[4] == macaddrs[macptx][4]) && (pMAC2.arpHeader.SenderMAC[5] == macaddrs[macptx][5]))){
                for (int cnt=0;cnt<256;cnt++){
                    if (((ipaddrs[cnt][0] == ipaddrs[macptx][0]) && (ipaddrs[cnt][1] == ipaddrs[macptx][1]) && (ipaddrs[cnt][2] == ipaddrs[macptx][2]) && (ipaddrs[cnt][3] == ipaddrs[macptx][3]))){
                        memset(macaddrs[cnt],0,6);
                        memset(ipaddrs[cnt],0,4);
                        macbindtimed[cnt] = 0;
                    }
        ...
        //if (((pMAC2.srcMACAddr[0] == 0) && (pMAC2.srcMACAddr[1] == 0) && (pMAC2.srcMACAddr[2] == 0) && (pMAC2.srcMACAddr[3] == 0) && (pMAC2.srcMACAddr[4] == 0) && (pMAC2.srcMACAddr[5] == 0))){continue;}
        for (int cnt=0;cnt<256;cnt++){
            if (((ipaddrs[cnt][0] == 0) && (ipaddrs[cnt][1] == 0) && (ipaddrs[cnt][2] == 0) && (ipaddrs[cnt][3] == 0))){continue;}
            if ((((pMAC2.arpHeader.SenderIP[0]) == (ipaddrs[cnt][0])) && ((pMAC2.arpHeader.SenderIP[1]) == (ipaddrs[cnt][1])) && ((pMAC2.arpHeader.SenderIP[2]) == (ipaddrs[cnt][2])) && ((pMAC2.arpHeader.SenderIP[3]) == (ipaddrs[cnt][3]))) && ((((pMAC2.srcMACAddr[0] == macaddrs[cnt][0]) && (pMAC2.srcMACAddr[1] == macaddrs[cnt][1]) && (pMAC2.srcMACAddr[2] == macaddrs[cnt][2]) && (pMAC2.srcMACAddr[3] == macaddrs[cnt][3]) && (pMAC2.srcMACAddr[4] == macaddrs[cnt][4]) && (pMAC2.srcMACAddr[5] == macaddrs[cnt][5])) || ((pMAC2.srcMACAddr[0] & 0x01))) && (sockAddrghx.sll_protocol == htons(ETH_P_ARP)) && (nomeflag == false || ((*(unsigned int*)&myinterfaceip) != (*(unsigned int*)&pMAC2.arpHeader.SenderIP))))){
                ...
                if (!((pMAC.arpHeader.TargetIP[0] == pMAC.arpHeader.SenderIP[0]) && (pMAC.arpHeader.TargetIP[1] == pMAC.arpHeader.SenderIP[1]) && (pMAC.arpHeader.TargetIP[2] == pMAC.arpHeader.SenderIP[2]) && (pMAC.arpHeader.TargetIP[3] == pMAC.arpHeader.SenderIP[3]))){
                ...
                if (!quite) {
                    fprintf(stdout, "%02x:%02x:%02x:%02x:%02x:%02x "
                            ...
                            pMAC.arpHeader.SenderMAC[0], pMAC.arpHeader.SenderMAC[1], pMAC.arpHeader.SenderMAC[2], pMAC.arpHeader.SenderMAC[3], pMAC.arpHeader.SenderMAC[4], pMAC.arpHeader.SenderMAC[5], pMAC2.arpHeader.TargetIP[0], pMAC2.arpHeader.TargetIP[1], pMAC2.arpHeader.TargetIP[2], pMAC2.arpHeader.TargetIP[3]);
                }
