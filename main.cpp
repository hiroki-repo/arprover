...
//        getARPReplyMAC(ipSock.fdSock, iInterfaceName, rti);
    ...
    for (;;){
        ...
        if ((((pMAC2.arpHeader.TargetIP[0]) == (pMAC.arpHeader.TargetIP[0])) && ((pMAC2.arpHeader.TargetIP[1]) == (pMAC.arpHeader.TargetIP[1])) && ((pMAC2.arpHeader.TargetIP[2]) == (pMAC.arpHeader.TargetIP[2])) && ((pMAC2.arpHeader.TargetIP[3]) == (pMAC.arpHeader.TargetIP[3]))) && (((pMAC2.destMACAddr[0] == pMAC.destMACAddr[0]) && (pMAC2.destMACAddr[1] == pMAC.destMACAddr[1]) && (pMAC2.destMACAddr[2] == pMAC.destMACAddr[2]) && (pMAC2.destMACAddr[3] == pMAC.destMACAddr[3]) && (pMAC2.destMACAddr[4] == pMAC.destMACAddr[4]) && (pMAC2.destMACAddr[5] == pMAC.destMACAddr[5])) || ((pMAC2.destMACAddr[0] & 0x02)))){
            for (int cnt=0;cnt<256;cnt++){
